...
public class GsonConverter {
     ...
     */
    private static final List<String> IGNORED_PROPERTIES_LIST = Arrays.asList("Children",
            "Thumbnails",
            "Permission");
     ...
     */
    public static GsonHttpMessageConverter getGsonConverterInstance() {
        ...
        final JsonDeserializer<Date> dateJsonDeserializer = new JsonDeserializer<Date>() {
            ...
            public Date deserialize(final JsonElement json,
                ...
                try {
                    ...
                    Log.e("JsonDeserializerDate", "Parsing issue on " + json.getAsString() + " ! " +
                            "" + e.toString());
                    return null;
                }
            }
