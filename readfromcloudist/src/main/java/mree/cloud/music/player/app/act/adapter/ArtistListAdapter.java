...
/**
 * Created by mree on 14.02.2016.
 */
public class ArtistListAdapter extends ArrayAdapter<SongInfo> implements Filterable {
    ...
    public Filter getFilter() {
        ...
        Filter filter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ArtistListAdapter.this.clear();
                filteredSongs = (ArrayList<SongInfo>) results.values;
                ArtistListAdapter.this.addAll(filteredSongs);
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                for (int i = 0; i < songs.size(); i++) {
                    String dataNames = songs.get(i).getArtist();
